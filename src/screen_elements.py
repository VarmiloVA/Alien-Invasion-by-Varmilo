...
class LeaderBoard():
    def __init__(self, ai_game):
        self.json_file = "data/leaderboard.json"
        self.screen = ai_game.screen
    ...
    def show_leaderboard(self):
        ...
        text_color = (0, 0, 0)
        lb_font1 = pygame.font.SysFont('Courier New', 18)
        lb_font2 = pygame.font.SysFont('Courier New', 16)
        lb_font3 = pygame.font.SysFont('Courier New', 14)
        ...
        if lb_dict is not None:
            ...
            for user, points in lb_dict.items():
                if position == 1:
                    text = f"1st. {user.capitalize()} ({points}pts)"
                    position += 1
                elif position == 2:
                    text2 = f"2nd. {user.capitalize()} ({points}pts)"
                    position += 1
                elif position == 3:
                    text3 = f"3rd. {user.capitalize()} ({points})"
